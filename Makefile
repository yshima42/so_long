...
LIBFT_PATH		= ./libft/
MLX_PATH		= ./mlx_linux/
SRCS_FILES    	= $(SRCS_PATH)main.c $(SRCS_PATH)utils.c $(SRCS_PATH)map_check.c $(SRCS_PATH)free.c $(SRCS_PATH)args_check.c $(SRCS_PATH)sl_utils.c $(SRCS_PATH)player_move.c
